        ...
        <div class="page-title">
            <div class="row">
                ...
                <div class="col-md-3  col-sm-3 col-xs-12 " >
                    <div class="">
                        <a type="button" href="{{route('mainCategory')}}" class="btn btn-info btn-lg" style="font-size: 15px;">Manage Category</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div id="response"></div>
                        <form id="main-category-create" data-parsley-validate class="form-horizontal form-label-left">
