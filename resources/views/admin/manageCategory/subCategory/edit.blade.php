            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <div id="response"></div>
                        <form id="sub-category-edit-submit" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <select class="form-control" id="main_category_id" name="main_category_id" required>
                                        ...
                                        @foreach($mainCategoryInfo as $category)
                                            <option <?php echo ($category->id==$categoryInfo->maincategory->id)?'selected':''?> value="{{$category->id}}">{{$category->category}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
