...
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">Girth Size</label>
    <div class="col-md-3 col-sm-3 col-xs-12">
        <select class="form-control" id="girth" name="girth"  required>
            <option value="" >--select Girth--</option>
            @foreach($girth as $gth)
                <option value="{{$gth->id}}">{{$gth->girth}}</option>
            @endforeach
        </select>
    </div>
</div>
