                            ...
                            <address>
                                <div class="row tile_count">
                                    <div class="col-md-6 col-sm-12 col-xs-12 tile_stats_count">
                                        ...
                                        <div class="count <?php echo ($item->quantity >= $item->min_quantity_level)?"green":"red"?>" ><input type="text" id ="current_quantity" name="current_quantity"  value="{{$item->quantity}}" disabled style="border: 0px !important;background-color: white"></div>
